...
async function submitOrder() {
    ...
    formData.append("linkfb", $('input[name="linkfb"]').val());
    ...
    formData.append("product6_qty", $('input[name="product6_qty"]').val() || 0);
    formData.append("product7_qty", $('input[name="product7_qty"]').val() || 0);
